...
public class CompressTrieTest{
    @Test
    public void testCompressOne() throws IOException {
	Trie t = new Trie();
	t.insert("one");
    ...
    @Test
    public void testCompressTwo() throws IOException{
	Trie t = new Trie();
	t.insert("one");
	t.insert("two");
	CompressedTrie c = CompressedTrie.compressTrie(t);
    ...
    @Test
    public void testCompressCommonPrefix() throws IOException{
	Trie t = new Trie();
	t.insert("one");
	t.insert("only");
	CompressedTrie c = CompressedTrie.compressTrie(t);
    ...
    @Test
    public void testCompressStock() throws IOException{
	Trie t = new Trie();
	t.insert("bear");
	t.insert("bell");
	t.insert("bid");
