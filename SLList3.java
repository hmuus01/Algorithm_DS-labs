class SLList {
    ...
    {
    //initalize sll of type int which contains the length of the object
        int sll = this.length();
    //if the length is less or equal to 1 return the object
            if (sll <= 1)
        {
            return this;
        }
        ...
        {
    //else initialze middle which containts the length divided by 2
        int middle = sll/2;
